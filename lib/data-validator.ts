...
export class DataValidator {
  ...
  // Process raw data using mapping template
  ...
  // Auto-detect data template based on column headers
  static detectDataTemplate(columnHeaders: string[]): DataMappingTemplate | null {
    ...
    // Return template if match score is above threshold
    return bestMatch && bestMatch.score > 0.3 ? bestMatch.template : null;
  }
